...
//				copy.right=right.clone();
	 ...
	 * 
	 */
	public ArrayList<String> calculateLabel(ArrayList<ArrayList<String>> testdata){
		ArrayList<String> predicts = new ArrayList<String>();
		for(ArrayList<String> record:testdata){
			String label = evaluate(record);
			if(label == null)
...
//			}
	 ...
	 * 
	 * @param record		the data matrix to be examined
